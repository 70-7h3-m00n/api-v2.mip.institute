...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    blog_author: Schema.Attribute.Relation<'manyToOne', 'api::author.author'>;
    blogs: Schema.Attribute.Relation<'manyToMany', 'api::blog.blog'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    isBase: Schema.Attribute.Boolean;
    isExpertOpinion: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiChatbotChatbot extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    options: Schema.Attribute.Component<'chat.variant', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroCarousel: Schema.Attribute.Component<'shared.rich-text-with-img', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiVacancyVacancy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'vacancies.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vacancy.vacancy'
